              ...
              <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarApps">
                  <ul class="nav nav-sm flex-column">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="#sidebarjobs" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarjobs" data-key="t-jobs">
                        {{ $t("t-jobs") }}
                      </a>
                      <div class="collapse menu-dropdown" id="sidebarjobs">
                        <ul class="nav nav-sm flex-column">
                          ...
                          <li class="nav-item">
                            <a class="nav-link" href="#sidebarjoblists" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarjoblists" data-key="t-projects">
                              {{ $t("t-job-lists") }}
                            </a>
